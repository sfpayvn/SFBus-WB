...
export class BusSchedulesComponent implements OnInit {
  ...
  editBusSchedule(busSchedule: any): void {
    ...
    this.router.navigateByUrl('/bus-management/bus-schedules/bus-schedule-detail', { state: params }); 
  }
  ...
  addBusSchedule(startDate?: Date): void {
    ...
    this.router.navigate(['/bus-management/bus-schedules/bus-schedule-detail']);
  }
