...
export class BusTemplatesComponent implements OnInit {
  ...
  editBusTemplate(busTemplate: BusTemplate): void {
    ...
    this.router.navigateByUrl('/bus-management/bus-templates/bus-template-detail', { state: params });
  }

  addBusTemplate(): void {
    this.router.navigate(['/bus-management/bus-templates/bus-template-detail']);
  }
