...
export class BusRoutesComponent implements OnInit {
  ...
  editBusRoute(busRoute: BusRoute): void {
    ...
    this.router.navigateByUrl('/bus-management/bus-design/bus-routes/bus-route-detail', { state: params });
  }

  addBusRoute(): void {
    this.router.navigate(['/bus-management/bus-design/bus-routes/bus-route-detail']);
  }
