...
import { BOOKING_STATUS, BOOKING_STATUS_LABELS, BOOKING_STATUS_CLASSES } from '@rsApp/core/constants/status.constants';
...
export class BookingReportComponent implements OnInit, OnDestroy {
   ...
   */
  getBookingStatuses(): { value: string; label: string }[] {
    return Object.entries(this.bookingStatusLabels).map(([value, label]) => ({
      value,
      label,
    }));
  }
