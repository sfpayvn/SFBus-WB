...
@Component({
  selector: "app-revenue-goods-chart",
  templateUrl: "./revenue-goods-chart.component.html",
  styleUrls: ["./revenue-goods-chart.component.scss"],
  standalone: false,
})
export class RevenueGoodsChartComponent implements OnChanges {
  chartOptions: any = {
    responsive: true,
  ...
  private loadChartData(): void {
    ...
    this.reportService.getRevenueGoodsChartStats(request).subscribe({
      next: (response) => {
        ...
        this.chartData = {
          ...
          datasets: [
            {
              label: this.comparisonMode ? this.translate.instant('common.currentPeriod') : this.translate.instant('reports.revenue'),
              data: currentData,
              borderColor: "#10b981",
