...
@Component({
  selector: 'app-revenue-goods-stats-card',
  templateUrl: './revenue-goods-stats-card.component.html',
  styleUrls: ['./revenue-goods-stats-card.component.scss'],
  standalone: false,
})
export class RevenueGoodsStatsCardComponent implements OnInit, OnChanges {
