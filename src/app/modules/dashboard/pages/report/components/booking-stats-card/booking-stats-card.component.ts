...
@Component({
  selector: 'app-booking-stats-card',
  templateUrl: './booking-stats-card.component.html',
  styleUrls: ['./booking-stats-card.component.scss'],
  standalone: false,
})
export class BookingStatsCardComponent implements OnInit, OnChanges {
  ...
  private loadData(): void {
    ...
    this.reportService.getBookingStats(request, true).subscribe({
      next: (response: any) => {
